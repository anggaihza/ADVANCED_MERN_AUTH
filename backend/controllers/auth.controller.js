...
import { resendResetSuccessEmail, sendPasswordResetEmail, sendVerificationEmail, sendWelcomeEmail } from "../mailtrap/emails.js";
...
export const login = async (req, res) => {
    ...
    try {
        ...
        if(!user) {
            return res.status(400).send({success: false, message: "Invalid creadentials"})
        }
...
export const resetPassword = async (req, res) => {
    try {
        ...
        await resendResetSuccessEmail(user.email)
